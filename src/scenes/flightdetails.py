...
PLANE_DISTANCE_FROM_TOP = 31 * screen.SCALE_FACTOR
FLIGHT_NO_TEXT_HEIGHT = 8 * screen.SCALE_FACTOR  # based on font size
...
DATA_INDEX_POSITION = (52 * screen.SCALE_FACTOR, 24 * screen.SCALE_FACTOR)
DATA_INDEX_TEXT_HEIGHT = 7 * screen.SCALE_FACTOR
